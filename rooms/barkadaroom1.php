...
<?php
    ...
    if ($result->num_rows > 0) {
        while ($row = $result->fetch_assoc()) {
            ...
            echo '<p><i class="bi bi-basket3-fill"></i> Private Comfort Room</p>';
            echo '</br>';
            echo '</br>';
            echo '<p>Experience luxury and comfort in our spacious deluxe room. 
            This room is elegantly furnished with modern amenities to make your stay enjoyable. 
            Enjoy breathtaking views from the resort and unwind in a cozy atmosphere. 
            Whether youre here for business or leisure, our deluxe room is the perfect choice.</p>';
            echo '</div>';      
            echo '</div>';
            ...
            echo '<img src="../assets/img/rooms/desc.jpg" class="img-desc" style="height:500px; ">';
            echo '</div>';
        }
    } else {
        echo "No rooms found.";
