...
<?php
    ...
    if ($result->num_rows > 0) {
        while ($row = $result->fetch_assoc()) {
            ...
            echo '</br>';
            echo '</br>';
            echo '<p>Welcome to our cozy air-conditioned cottage, where comfort meets tranquility. This well-appointed retreat offers a perfect blend of modern amenities and rustic charm, providing you with a delightful escape from the hustle and bustle of everyday life.</p>';
            echo '</div>';      
            echo '</div>';
            ...
            echo '<img src="../assets/img/rooms/desc2.jpg" class="img-desc" style="height:500px; ">';
            echo '</div>';
        }
    } else {
        echo "No rooms found.";
