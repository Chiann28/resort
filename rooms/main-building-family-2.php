...
<?php
    ...
    if ($result->num_rows > 0) {
        while ($row = $result->fetch_assoc()) {
            ...
            echo '</br>';
            echo '</br>';
            echo '<p>Experience the perfect family getaway in our spacious and air-conditioned family cottage. Designed with your comfort and convenience in mind, this retreat provides a welcoming environment for families to create cherished memories together.</p>';
            echo '</div>';      
            echo '</div>';
            ...
            echo '<img src="../assets/img/rooms/desc4.jpg" class="img-desc" style="height:500px; ">';
            echo '</div>';
        }
    } else {
        echo "No rooms found.";
