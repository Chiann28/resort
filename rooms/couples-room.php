...
<?php
    ...
    if ($result->num_rows > 0) {
        while ($row = $result->fetch_assoc()) {
            ...
            echo '</br>';
            echo '</br>';
            echo '<p>Indulge in the ultimate romantic getaway with our specially crafted air-conditioned couples cottage. Nestled in a serene corner of our property, this intimate retreat is designed for couples seeking a romantic escape in a charming and comfortable setting.</p>';
            echo '</div>';      
            echo '</div>';
            ...
            echo '<img src="../assets/img/rooms/desc3.jpg" class="img-desc" style="height:500px; ">';
            echo '</div>';
        }
    } else {
        echo "No rooms found.";
