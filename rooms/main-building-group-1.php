...
<?php
    ...
    if ($result->num_rows > 0) {
        while ($row = $result->fetch_assoc()) {
            ...
            echo '</br>';
            echo '</br>';
            echo '<p>Gather your friends or colleagues for an unforgettable group experience in our spacious and air-conditioned group cottage. Perfect for larger parties, this retreat is designed to accommodate groups in comfort and style, providing a welcoming space for shared moments and camaraderie.</p>';
            echo '</div>';      
            echo '</div>';
            ...
            echo '<img src="../assets/img/rooms/desc5.jpg" class="img-desc" style="height:500px; ">';
            echo '</div>';
        }
    } else {
        echo "No rooms found.";
