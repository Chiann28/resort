        ...
        if($validationchecker == 0)
        {
          ...
          if ($result->num_rows > 0) 
          {
              while ($row = $result->fetch_assoc()) 
              {
                  ...
                  $room_number = '';
                  if($room_id != ''){
                    $roomQuery = "SELECT price, description, room_number FROM rooms WHERE room_id = '{$row['room_id']}'";
                    ...
                    if ($roomResult->num_rows > 0) {
                        ...
                        $room_name = $roomData['description'];
                  ...
                  if ($conn->query($sql) === TRUE) {
                    ...
                    $_SESSION['recently_booked'] = "You have successfully reserved our room/services, Thank you for choosing our resort.";
                        }else{

                            $_SESSION['recently_booked'] = "You have successfully reserved room: ".$room_number." [".$room_name."], Thank you for choosing our resort.";
                        }
    ...
    <body>
        ...
        <?php 
            ...
            if($result->num_rows == 0 && $servicesResult->num_rows == 0){
                ...
                width: 50%;
                border-radius:1vh;
                '>".$_SESSION['recently_booked']."</div></center><br><br>";
                }else{
