...
if ($_SERVER['REQUEST_METHOD'] === 'GET' && isset($_GET['reservation_id'])) {
    ...
    $update_sql = "UPDATE reservations 
                   ...
                   SET paid_amount = '$amount', down_payment = '$downpayment' 
    ...
    if ($conn->query($update_sql) === TRUE) {
                ...
                $audit_action = "Set fully paid reservation ID: ".$reservation_id;
        ...
        try {
            ...
            $mail->Subject = 'Thank You For Paying';

            $mail->Body = "Dear $name,<br><br>Thank you for settling your balance amount. We will ensure that our service will be outstanding.<br><br>Best regards,<br>Kamantigue Beach Resort";
        ...
        header("Location: cashier_module.php");
