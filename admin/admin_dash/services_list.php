					...
					<ul>
						...
						<li class="submenu"> <a href="#"><i class="fas fa-key"></i> <span> Rooms </span> <span class="menu-arrow"></span></a>
							<ul class="submenu_class" style="display: none;">
								...
								<li><a href="services_list.php" class="active"> Services </a></li>
			...
			<div class="content container-fluid">
				<div class="page-header">
					<div class="row align-items-center">
						<div class="col">
							<div class="mt-5">
								<h4 class="card-title float-left mt-2">Services</h4>
                                <a onclick='openAddPopup()' class="btn btn-primary float-right veiwbutton ">Add Services</a>
                            </div>
						</div>
					</div>
				</div>
								...
								<div class="table-responsive">
									<table>
                                            ...
                                            while ($list_services_row = $result->fetch_assoc()) {
                                                ...
                                                echo "<td><a class='btn btn-success' style='width:100px;' onclick='openEditPopup(" . $list_services_row['services_number'] . ")')'>Edit</button></td>";
                                                echo "<td><a class='btn btn-danger' href='delete_services.php?services_number=" . $list_services_row['services_number'] . "' onclick='return confirm(\"Are you sure you want to delete this service?\")'>Delete</a></td>";
                                                echo "</tr>";
