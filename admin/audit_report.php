  ...
  <div class="main-content">
    ...
    <main>
        <div class="page-header" style="display: flex; align-items: center; margin-top: -50;">
            <h1 style="margin-right: 10px;">Audit Report</h1>
                <small>Home / Audit Report</small> <button onclick="printTable()" style="margin-left:0.5vh; background-color:gray; color:white;">Print Report</button>
