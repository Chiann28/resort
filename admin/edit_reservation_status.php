...
if ($_SERVER['REQUEST_METHOD'] === 'GET' && isset($_GET['reservation_id']) && isset($_GET['status'])) {
    ...
    if ($conn->query($update_sql) === TRUE) {
        ...
        try {
            ...
            $mail->Body = "Dear $name,<br><br>Thank you for reserving a room on our website. Your reservation is now confirmed.<br><br>Best regards,<br>Kamantigue Beach Resort";
